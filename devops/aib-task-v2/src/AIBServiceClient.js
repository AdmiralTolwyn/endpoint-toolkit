...
const AzureServiceClient_1 = require("azure-pipelines-tasks-azure-arm-rest/AzureServiceClient");
// AIBServiceClient extends ServiceClient from azure-arm-rest, with some modifications
class AIBServiceClient extends AzureServiceClient_1.ServiceClient {
    // getLongRunningOperationResult extends the same-name function in azure-arm-rest, with retry on http timeout
    async getLongRunningOperationResult(response, timeoutInMinutes) {
...
exports.default = AIBServiceClient;
