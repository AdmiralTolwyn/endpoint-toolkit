...
├── diagnostics/    # Read-only endpoint diagnostics — Location policy state, Defender/EDR coexistence, Delivery Optimization stats, power/standby evidence, audio artifact investigation
