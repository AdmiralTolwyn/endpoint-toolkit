...
function Update-WinGetSource {
    ...
    | BasicV2    | Same as Basic but deploys APIM Basic v2 SKU (supports VNet integration and private endpoints).                       |
    | StandardV2 | Same as Enhanced but deploys APIM Standard v2 SKU (supports VNet integration and private endpoints).                  |
