...
function Invoke-IntuneDiscoveryCore {
    ...
    return [ordered]@{
        ...
        Collector = @{ Name = 'Invoke-IntuneDiscovery'; Version = '0.5.9' }; Tenant = @{ Id = $SelectedTenant; Cloud = 'Global' }
...
try {
    ...
    $script:IntuneHttpClient.DefaultRequestHeaders.UserAgent.ParseAdd('IntuneAssessor/0.5.9')
    $PlainToken = $null
    $Requirements = @{}
