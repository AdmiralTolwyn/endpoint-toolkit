@echo off
:: ---------------------------------------------------------------------
:: Azure Change Tracker Launcher (Clean Session)
:: Starts a fresh PowerShell session with no profile to avoid
:: Az module version conflicts from pre-loaded assemblies.
...
start "" /MAX %PS_EXE% -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File "AzChangeTracker.ps1"
